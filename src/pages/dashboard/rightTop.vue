...
<script>
	...
	export default {
		...
		computed: {
			...mapGetters(['cityId', 'time', 'networkType', 'timeTypeId']),
			dataRange() {
				const {
					time,
					cityId,
...
<style lang="scss" scoped>
	...
	.BlueHorn {
		...
		scrollbar-arrow-color: rgba(4, 16, 77, 0.1);
		/**/
		/*三角箭头的颜色*/
		scrollbar-face-color: #3661b3;
		/**/
		/*立体滚动条的颜色*/
		scrollbar-3dlight-color: #3661b3;
		/**/
		/*立体滚动条亮边的颜色*/
		scrollbar-highlight-color: rgba(4,
		16,
		77,
		0.1);
		/**/
		/*滚动条空白部分的颜色*/
		scrollbar-shadow-color: #3661b3;
		/**/
		/*立体滚动条阴影的颜色*/
		scrollbar-darkshadow-color: #3661b3;
		/**/
		/*立体滚动条强阴影的颜色*/
		scrollbar-track-color: rgba(4, 16, 77, 0.1);
		/**/
		/*立体滚动条背景颜色*/
		scrollbar-base-color: #3661b3;
		/**/
		/*滚动条的基本颜色*/
	}
</style>
