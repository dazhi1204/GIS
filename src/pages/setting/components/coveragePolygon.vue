	...
	<div class="content-box">
		<div>
			...
			<div class="config-item buttom">
				...
				<div class="divider"></div>
				<p>显示多边形名称:
					<el-switch v-model="showPolygon" style="float: right;" active-color="#13ce66" inactive-color="#ff4949">
					</el-switch>
				</p>
