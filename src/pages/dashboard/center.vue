<template>
	<div class="map-box">
		...
		<!--点击弹窗-->
		<detial-dialog v-show="mesFalse2 && rowDataList.length > 0" :row-data-list="rowDataList" :dialogStyle="dialogStyle"
		 :village="village" @close="mesFalse2 = false"></detial-dialog>
